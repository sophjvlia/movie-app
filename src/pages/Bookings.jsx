...
const Bookings = () => {
  ...
  const handleEditConfirm = async () => {
    try {
      ...
      try {
        const response = await axios.post(`https://booking-system-api-sophjvlias-projects.vercel.app/edit-booking/${booking.booking_id}`, {
          movie_id: movieId,
              ...
              <div className="bg-white booking">
                ...
                <div className="ms-2">
                  ...
                  <div className="d-flex justify-content-end pe-2">
                    <i className="bi bi-pencil-square text-warning me-2" style={{ cursor: "pointer" }} onClick={() => handleEditClick(booking)}></i>
      ...
      <Modal show={showEditModal} onHide={handleEditCancel}>
        ...
        <Modal.Body>
          ...
          <div className="seat-selection px-0">
            <h4 className="text-dark fw-bold mb-3">Select Your Seats</h4>
                      ...
                      {[1, 2, 3].map((col, colIndex) => {
                        ...
                        return (
                          <button
                            key={colIndex}
                            value={seatNumber}
                            className={`seat mx-1 btn btn-outline-light ${availableSeat.booking_status === 1 ? 'btn-secondary' : 'btn-outline-light'} ${selectedSeat === seatNumber ? 'selected' : ''}`}
